...
public class Steps extends Metodos {
	...
	public void que_esteja_no_site_para_informar_dados_do_veiculo(String appUrl) throws Throwable {
		metodos.abrirNavegador(appUrl, "CHROME", "acessando a tela para realizar cotação");
	}
	...
	metodos.screnShoot("informar os dados do veiculo");
		
	}

	@Quando("^informar os dados do seguro$")
	public void informar_os_dados_do_seguro() throws Throwable {
		cotacao.preencherDadosSeguro("Felipe", "Leal", "01/16/1992");
	...
	public void informar_os_dados_do_produto() throws Throwable {
		cotacao.preencherInformacoesProduto("05/15/2021", 10000000,"Bonus 1");
