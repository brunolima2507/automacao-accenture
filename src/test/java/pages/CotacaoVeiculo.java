...
public class CotacaoVeiculo {
	...
	public void preencherDadosSeguro(String firstName, String lastName, String bDay) throws IOException {
		...
		metodos.preencher(elemento.getStreetaddress(), "Estrada Itaquera-Guaianeses", "preenchendo rua");
		metodos.selecionarComboTexto(elemento.getCountry(), "Brazil", "selecionando o país");
		metodos.preencher(elemento.getZipcode(), "08420000", "preenchendo CEP");
	...
	public void enviarCotacao() throws IOException {
		metodos.preencher(elemento.getEmail(), "felipe.leal@google.com", "preenche o e-mail");
		metodos.preencher(elemento.getPhone(), "11985636482", "preenche o telefone");
		metodos.preencher(elemento.getUsername(), "Felipe", "preenche o nome");
		metodos.preencher(elemento.getPassword(), "Accenture2021", "preenche password");
		metodos.preencher(elemento.getConfirmpassword(), "Accenture2021", "confirma password");
